...
const CustomMenuVentas = ({ itemName, itemOpen, BtnMostrar, BtnRegistrar1, nombreBtn1, BtnListar1, nombreBtn2, BtnListar2, drawerOpen, icon }) => {
...
export default CustomMenuVentas;
